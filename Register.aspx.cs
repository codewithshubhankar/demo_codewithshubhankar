...
public partial class Ecommerce_website_Register : System.Web.UI.Page
{
    ...
    protected void btnRegister_Click(object sender, EventArgs e)
    {
        ...
        if (fileProfileImage.HasFile)
        {
            ...
            fileProfileImage.PostedFile.SaveAs(Server.MapPath("~/Ecommerce-website/ProfileImages1/" + str));
            string Image = "~/Ecommerce-website/ProfileImages1/" + str.ToString();
            ...
            try
            {
                ...
                {
                    connection.Open();
                    string query = "INSERT INTO Users5 (Username, Email, Password, ProfileImage,UserRole,mobile) VALUES (@Username, @Email, @Password, @ProfileImage,@UserRole,@mobile)";
